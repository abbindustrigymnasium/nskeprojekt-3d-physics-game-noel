...
public class SwingingDone : MonoBehaviour {
    ...
    private void Awake() {
        ...
        itemSw = player.GetComponent<ItemSwitch>();
        if (itemSw == null) {
            return;
        }

        bool isGrappling = itemSw.IsGrappling();
        print(isGrappling);
    }
    ...
    private void Update() {
        ...
        bool ItemSwitcher = itemSw.IsGrappling();
        if (ItemSwitcher) {
